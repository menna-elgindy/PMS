...
export default function Registration() {
  ...
  const [imageFile, setImageFile] = useState<
    string | null | FileList | string[] | Blob
  >();
  ...
  const uploadImage = (
    selectorFiles: string | null | undefined | FileList | string[]
  ) => {
    if (selectorFiles) {
  ...
  const onSubmit: SubmitHandler<RegisterFormData> = async (data) => {
    ...
    await axiosInstance
      .post(BASE_AUTH + AUTH_URLS.register, formData)
      .then((resp) => {
        console.log(resp);
            ...
            <div className=" d-flex justify-content-center">
              <div className={`${styles.formContainer}`}>
                <div className={styles.title}>
                  ...
                  <h2 className={`${styles.textWrapper} position-relative`}>
                    Create New Account
                  </h2>
                </div>
                  ...
                  <div className="container">
                    {imageFile ? (
                      <>
                        {imageFile && (
                          <div
                            className={`${styles.formImage}  position-relative`}
                          >
                            <img
                              className="w-75"
                            ...
                            />
                            <button
                              className={`${styles.discardBtn} btn`}
                              onClick={discardProfileImage}
                            >
                              <i className="fa-solid fa-xmark "></i>
                              <span className="sr-only">
                                {imageFile
                                  ? "discard upload profile image"
                        ...
                        <div className="input position-relative">
                          <div className="position-relative">
                            ...
                            <button
                              ...
                              type="button"
                              onClick={toggleHideShowRePassword}
                              className={styles.iconsBtn}
                            >
                              <i
                                aria-label="password-toggle"
